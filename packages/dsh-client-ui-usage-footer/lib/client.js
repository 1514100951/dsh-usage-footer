window.__ModuleLoader__.load({
	...
	factory: (require) => {
				...
				children: jsxs(Fragment, { children: [
					...
					jsxs(Fragment, { children: [
						...
						jsxs("div", { className: "uW_todayCell", title: t("panel.todayNote"), children: [
							jsxs("div", { className: "uW_todayHead", children: [
								jsx("span", { className: "uW_todayLabel", children: t("panel.today") }),
								jsx("span", { className: "uW_todayTokens", children: t("panel.todayTokens", { total: formatTokens(todayTotal) }) })
							] }),
							jsx("div", { className: "uW_todayCost", children: t("panel.todayCost", { off: formatMoney(todayCost.offPeak), peak: formatMoney(todayCost.peak) }) })
						] }),
		...
		const zh = {
			...
			"panel.output": "输出",
			"panel.cost": "消费估算",
			"panel.today": "今日用量统计（本机估算）",
			"panel.todayTokens": "{total} token",
			"panel.todayCost": "空闲 ≈ ¥{off} · 高峰 ¥{peak}",
			"panel.todayNote": "非官方账单：统计本机今日产生的 token（跨浏览器/未打开页面的用量不计入），金额按峰谷价目估算",
		...
		const en = {
			...
			"panel.today": "Today's usage (local estimate)",
			"panel.todayTokens": "{total} tokens",
			"panel.todayCost": "Off-peak ≈ ¥{off} · Peak ¥{peak}",
			"panel.todayNote": "Not the official bill: locally observed tokens produced today (usage while no page was open is not counted), priced with the peak/off-peak table",
