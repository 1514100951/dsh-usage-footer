window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		/** Coin glyph: a token medallion with the currency notch. */
		function CoinGlyph() {
			return jsx("svg", {
				className: "uW_coin",
				viewBox: "0 0 24 24",
				...
				"aria-hidden": true,
				children: [
					jsx("circle", { cx: 12, cy: 12, r: 8.6, stroke: "currentColor", strokeWidth: 1.6 }),
					jsx("path", {
						d: "M12 8.2v7.6M12 8.2c-1.9-.4-3.4.9-3.4 2.1 0 2.6 6.8 1.3 6.8 3.6 0 1.2-1.5 2.4-3.4 2-1.2-.3-2.3-1.1-2.3-2.1",
						stroke: "currentColor",
						strokeWidth: 1.3,
						strokeLinecap: "round"
					})
		...
		/** Bottom-right floating usage widget: button + hover popup. */
			...
			const panel = jsx("div", {
				...
				children: jsxs(Fragment, { children: [
					jsxs("div", { className: "uW_head", children: [
						...
						jsx("span", { className: "uW_dot", "data-bracket": bracket })
					] }),
					...
					jsxs(Fragment, { children: [
						...
						jsxs("div", { className: "uW_todayCell", title: t("panel.todayNote"), children: [
							jsx("span", { className: "uW_todayLabel", children: t("panel.today") }),
							jsx("span", { className: "uW_todayValue", children: "¥" + formatMoney(todayCost.offPeak) }),
							jsx("span", { className: "uW_todayPeak", children: t("panel.todayPeak", { amount: formatMoney(todayCost.peak) }) })
						] }),
			...
			return jsx(Fragment, {
				children: [
					jsxs("div", {
						...
						className: "uW_root",
						children: [
							jsx("span", { className: "uW_ring", "data-bracket": bracket, "aria-hidden": true }),
							jsx("button", {
								type: "button",
								className: "uW_button",
								"aria-label": t("button.label"),
		...
		const zh = {
			...
			"panel.output": "输出",
			"panel.cost": "消费估算",
			"panel.today": "今日消费（本机统计）",
			"panel.todayPeak": "高峰 ¥{amount}",
			"panel.todayNote": "按本机今日累计 token × 峰谷价目估算；跨浏览器/未打开页面的用量不计入",
			...
			"settings.description": "右下角悬浮按钮，悬停显示余额、峰谷时段、今日/本会话消费估算与累计 token",
			"settings.enabled": "开启",
		...
		const en = {
			...
			"panel.today": "Today (local)",
			"panel.todayPeak": "Peak ¥{amount}",
			"panel.todayNote": "Estimated from today's locally observed tokens; usage while no page was open is not counted",
			...
			"settings.description": "Floating button at bottom right; hover to see balance, peak/off-peak, today/session cost and tokens",
			"settings.enabled": "On",
